<?php
/**
 * Elementor order payment widget.
 *
...
class Schrack_Elementor_Order_Pay_Widget extends \Elementor\Widget_Base {
	/**
	 * Widget slug.
	 */
	public function get_name(): string {
		return 'schrack_order_pay';
	}
	...
	public function get_title(): string {
		return __( 'Plata comanda Schrack', 'schrack-woocommerce-sync' );
	}
	...
	protected function register_controls(): void {
		...
		$this->add_control(
			...
			array(
				...
				'default'   => __( 'Plata comanda', 'schrack-woocommerce-sync' ),
				'condition' => array(
					'show_header' => 'yes',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'type'      => \Elementor\Controls_Manager::TEXT,
				'default'   => __( 'Finalizeaza plata comenzii', 'schrack-woocommerce-sync' ),
				'condition' => array(
					'show_header' => 'yes',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'default'   => __( 'Verifica detaliile comenzii si alege metoda de plata disponibila.', 'schrack-woocommerce-sync' ),
				'condition' => array(
					'show_header' => 'yes',
				),
			)
		...
		$this->add_control(
			'show_steps',
			array(
				'label'        => __( 'Afiseaza pasii platii', 'schrack-woocommerce-sync' ),
				'type'         => \Elementor\Controls_Manager::SWITCHER,
				'label_on'     => __( 'Da', 'schrack-woocommerce-sync' ),
				'label_off'    => __( 'Nu', 'schrack-woocommerce-sync' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'order_pay_heading',
			array(
				'label'   => __( 'Titlu zona plata', 'schrack-woocommerce-sync' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Finalizeaza plata', 'schrack-woocommerce-sync' ),
			)
		);
		...
		$this->add_control(
			'order_pay_badge',
			array(
				'label'   => __( 'Eticheta zona plata', 'schrack-woocommerce-sync' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Plata securizata', 'schrack-woocommerce-sync' ),
			)
		);
		...
		$this->add_control(
			...
			array(
				'label'   => __( 'Text buton plata', 'schrack-woocommerce-sync' ),
				'type'    => \Elementor\Controls_Manager::TEXT,
				'default' => __( 'Plateste comanda', 'schrack-woocommerce-sync' ),
			)
		);
	...
	protected function render(): void {
		...
		$settings['render_mode'] = 'order_pay';
